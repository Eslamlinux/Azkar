...
const azkarMasaData = [
  ...
  {
    id: 3,
    arabic: "بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ <br />قُلْ هُوَ اللَّهُ أَحَدٌ اللَّهُ الصَّمَدُ لَمْ يَلِدْ وَلَمْ يُولَدْ وَلَمْ يَكُنْ لَهُ كُفُوًا أَحَدٌ",
    count: 3,
    source: "سورة الإخلاص",
  },
  {
    id: 4,
    arabic: "بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ قُ<br />لْ أَعُوذُ بِرَبِّ الْفَلَقِ مِنْ شَرِّ مَا خَلَقَ وَمِنْ شَرِّ غَاسِقٍ إِذَا وَقَبَ وَمِنْ شَرِّ النَّفَّاثَاتِ فِي الْعُقَدِ وَمِنْ شَرِّ حَاسِدٍ إِذَا حَسَدَ",
    count: 3,
    source: "سورة الفلق",
  },
  {
    id: 5,
    arabic: "بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ قُ<br />لْ أَعُوذُ بِرَبِّ النَّاسِ مَلِكِ النَّاسِ إِلَهِ النَّاسِ مِنْ شَرِّ الْوَسْوَاسِ الْخَنَّاسِ الَّذِي يُوَسْوِسُ فِي صُدُورِ النَّاسِ مِنَ الْجِنَّةِ وَالنَّاسِ",
    count: 3,
    source: "سورة الناس",
  },
  ...
  },
{
  ...
  {
    id: 33,
    arabic: "اللَّهُمَّ أَغْنِنِي بِحَلاَلِكَ عَنْ حَرَامِكَ وَبِفَضْلِكَ عَمَّنْ سِوَاكَ",
    count: 1,
    source: "رواه الترمذي",
  },
  {
...
export default function AzkarMasaPage() {
  const [completedAzkar, setCompletedAzkar] = useState<number[]>([])

  useEffect(() => {
    const completed = localStorage.getItem("azkar-masa-completed")
    if (completed) {
  ...
  const handleComplete = (zikrId: number) => {
    ...
    localStorage.setItem("azkar-masa-completed", JSON.stringify(newCompleted))
  }
  ...
  return (
    <div className="min-h-screen bg-background spiritual-gradient dark:bg-gray-900">
      ...
      <header className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16 shadow-lg">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 animate-fade-in-up">أذكار المساء</h1>
          <p className="text-xl opacity-90 max-w-2xl mx-auto leading-relaxed animate-fade-in-up">
            أذكار وأدعية المساء المأثورة من القرآن الكريم والسنة النبوية الشريفة
          </p>
          <div className="mt-6">
            <div className="inline-block bg-white/20 text-white px-6 py-2 rounded-full text-lg animate-pulse-gentle border border-white/30">
              {azkarMasaData.length} ذكر ودعاء
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 text-center">
            ...
            <Card className="p-8 hover-lift border-blue-200 dark:bg-gray-800 dark:border-blue-800">
