          ...
          <div className="space-y-6">
            {azkarSabahData.map((zikr, index) => (
              <SharedZikrCard
                ...
                storageKey="azkar-sabah"
              />
            ))}
          </div>

          <div className="mt-16 text-center">
            <Separator className="mb-8 bg-border dark:bg-gray-700" />
            <Card className="p-8 hover-lift border-primary/20 dark:bg-gray-800">
